...
if (stickerpack.spackname == '') {
  var sticker_name = '@TayoBotz'
  var sticker_author = '6283842969296'
} else {
  var sticker_name = stickerpack.packname
  var sticker_author = stickerpack.author
}
